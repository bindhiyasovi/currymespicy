...
router.get('/posts', function(req,res,next){
      ...
      //Starts
      console.log("Starts : ",$result);
      /*
      foreach ( as row){
          cmsDB.query('select ID, post_title, guid from wp_posts where post_parent=row['ID'] AND post_type="attachment" and post_title!="" and post_content!="";', function(err,rows){  
          if(!err){
            console.log('The solution is: ',rows);
            res.json(rows);
          } else {
